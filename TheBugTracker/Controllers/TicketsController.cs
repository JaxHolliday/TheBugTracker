...
namespace TheBugTracker.Controllers
{
    ...
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> AssignDeveloper(int id)
        {
            ...
            //TODO - look at later
            //need to get the project id for the ticket in use for that specific project
        ...
        public async Task<IActionResult> AssignDeveloper(AssignDeveloperViewModel model)
        {
            if (model.DeveloperId != null)
            {
                ...
                //New Ticket | capturing history upon the assigning of new developer
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,ProjectId,TicketTypeId,TicketPriorityId")] Ticket ticket)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    //null since there is new old ticket currently 
        ...
        public async Task<IActionResult> AddTicketAttachment([Bind("Id,FormFile,Description,TicketId")] TicketAttachment ticketAttachment)
        {
            ...
            if (ModelState.IsValid && ticketAttachment.FormFile != null)
            {
                try
                {
                    ...
                    //Add History | ticketID for ticket, explicit model reference, UserID
        ...
        //private since it only fopr this class
